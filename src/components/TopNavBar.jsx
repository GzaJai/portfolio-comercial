...
export default function TopNavBar() {
  ...
  const { nav, siteName, whatsapp } = links;
  ...
  return (
    <nav className="sticky top-0 z-50 w-full bg-smooth-fade relative">
      ...
      {/* Content */}
      <div className="flex justify-between items-center max-w-container-max mx-auto px-6 md:px-24 h-20">
        {/* Logo */}
      ...
      {mobileOpen && (
        <div className="absolute top-full left-0 right-0 bg-surface/95 backdrop-blur-md md:hidden shadow-lg">
